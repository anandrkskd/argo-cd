...
func (ctrl *ApplicationController) autoSync(app *appv1.Application, syncStatus *appv1.SyncStatus, resources []appv1.ResourceStatus, revisionUpdated bool) (*appv1.ApplicationCondition, time.Duration) {
	...
	if app.Spec.SyncPolicy == nil || !*app.Spec.SyncPolicy.Automated.IsAutomatedSyncEnabled() {
		return nil, 0
	}
...
func automatedSyncEnabled(oldApp *appv1.Application, newApp *appv1.Application) bool {
	...
	if oldApp.Spec.SyncPolicy != nil && *oldApp.Spec.SyncPolicy.Automated.IsAutomatedSyncEnabled() {
		oldEnabled = true
	...
	if newApp.Spec.SyncPolicy != nil && *newApp.Spec.SyncPolicy.Automated.IsAutomatedSyncEnabled() {
		newEnabled = true
